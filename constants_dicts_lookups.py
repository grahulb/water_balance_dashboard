...
district_taluka_major_crops_dict = {
	...
	('Latur', 'Latur'): 'soybean',
	('Latur', 'Ausa'): 'soybean',
	('Latur', 'Ahmedpur'): 'soybean',
	('Latur', 'Nilanga'): 'soybean',
    ('Latur', 'Shirur'): 'soybean',
    ('Latur', 'Udgir'): 'soybean',
    ('Latur', 'Chakur'): 'soybean',
    ('Latur', 'Renapur'): 'soybean',
    ('Latur', 'Devani'): 'soybean',
    ('Latur', 'Jalkot'): 'soybean',
	('Osmanabad', 'Osmanabad'): 'soybean',
	('Osmanabad', 'Tuljapur'): 'tur',
	('Osmanabad', 'Paranda'): 'sugarcane',
	('Osmanabad', 'Bhoom'): 'tur',
	('Osmanabad', 'Kalamb'): 'soybean',
	('Osmanabad', 'Umerga'): 'tur',
	('Osmanabad', 'Vashi'): 'soybean',
	('Osmanabad', 'Lohara'): 'soybean',
	('Nanded', 'Nanded'): 'cotton',
	('Nanded', 'Mudkhed'): 'soybean',
	('Nanded', 'Ardhapur'): 'soybean',
	('Nanded', 'Biloli'): 'cotton',
	('Nanded', 'Dharmabad'): 'cotton',
	('Nanded', 'Naygaon'): 'soybean',
	('Nanded', 'Mukhed'): 'sorghum',
	('Nanded', 'Kandhar'): 'soybean',
	('Nanded', 'Loha'): 'soybean',
	...
	('Hingoli', 'Hingoli'): 'soybean',
	('Hingoli', 'Aundha'): 'soybean',
	('Hingoli', 'Sengaon'): 'soybean',
	('Hingoli', 'Kalamnuri'): 'soybean',
	('Hingoli', 'Basmath'): 'soybean',
	('Buldana', 'Jalgaon Jamod'): 'cotton',
	('Buldana', 'Sangrampur'): 'cotton',
	('Buldana', 'Chikhali'): 'soybean',
	('Buldana', 'Buldhana'): 'soybean',
	('Buldana', 'Deulgaon Raja'): 'cotton',
	('Buldana', 'Mehakar'): 'soybean',
	('Buldana', 'Sindkh Raja'): 'soybean',
	('Buldana', 'Lonar'): 'soybean',
	...
	('Akola', 'Balapur'): 'soybean',
	('Akola', 'Patur'): 'soybean',
	('Akola', 'Akola'): 'soybean',
	('Akola', 'Barshi Takli'): 'soybean',
	('Akola', 'Murtijapur'): 'soybean',
	('Amravati', 'Dharni'): 'soybean',
	('Amravati', 'Chikhaldara'): 'soybean',
	('Amravati', 'Amravati'): 'soybean',
	('Amravati', 'Bhatkuli'): 'soybean',
	('Amravati', 'Nadgaon Khandeshwar'): 'soybean',
	('Amravati', 'Chandur Railway'): 'soybean',
	('Amravati', 'Tiwasa'): 'soybean',
	('Amravati', 'Morshi'): 'soybean',
	('Amravati', 'Warud'): 'cotton',
	('Amravati', 'Daryapur'): 'moong',
	('Amravati', 'Anjangaon'): 'soybean',
	('Amravati', 'Achalpur'): 'cotton',
	('Amravati', 'Chandur Bazar'): 'soybean',
	('Amravati', 'Dhamangaon Railway'): 'soybean',
	('Washim', 'Washim'): 'soybean',
	('Washim', 'Risod'): 'soybean',
	('Washim', 'Malegaon'): 'soybean',
	('Washim', 'Mangrulpir'): 'soybean',
	('Washim', 'Manora'): 'soybean',
	('Washim', 'Karanja'): 'soybean',
